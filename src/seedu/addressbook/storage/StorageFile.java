...
public class StorageFile extends Storage {
    ...
    /**
     * @throws InvalidStorageException if the default path is invalid
     */
    public StorageFile() throws InvalidStorageException {
        this(DEFAULT_STORAGE_FILEPATH);
    }

    /**
     * @throws InvalidStorageException if the given file path is invalid
     */
    public StorageFile(String filePath) throws InvalidStorageException {
        try {
        ...
        if (!isValidPath(path)) {
            throw new InvalidStorageException("Storage file should end with '.txt'");
        }
    }
